...
interface IElixirPoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IElixirPoolDerivedState extends Contract {
  ...
  interface: IElixirPoolDerivedStateInterface;

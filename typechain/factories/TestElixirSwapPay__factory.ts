...
export class TestElixirSwapPay__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<TestElixirSwapPay> {
    return super.deploy(overrides || {}) as Promise<TestElixirSwapPay>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): TestElixirSwapPay {
    return super.attach(address) as TestElixirSwapPay;
  }
  connect(signer: Signer): TestElixirSwapPay__factory {
    return super.connect(signer) as TestElixirSwapPay__factory;
  }
  static connect(
    address: string,

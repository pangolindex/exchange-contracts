...
import type { TestPangolinV2SwapPay } from "../TestPangolinV2SwapPay";

export class TestPangolinV2SwapPay__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<TestPangolinV2SwapPay> {
    return super.deploy(overrides || {}) as Promise<TestPangolinV2SwapPay>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): TestPangolinV2SwapPay {
    return super.attach(address) as TestPangolinV2SwapPay;
  }
  connect(signer: Signer): TestPangolinV2SwapPay__factory {
    return super.connect(signer) as TestPangolinV2SwapPay__factory;
  }
  static connect(
    address: string,

...
import type { PangolinV2PoolDeployer } from "../PangolinV2PoolDeployer";

export class PangolinV2PoolDeployer__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<PangolinV2PoolDeployer> {
    return super.deploy(overrides || {}) as Promise<PangolinV2PoolDeployer>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): PangolinV2PoolDeployer {
    return super.attach(address) as PangolinV2PoolDeployer;
  }
  connect(signer: Signer): PangolinV2PoolDeployer__factory {
    return super.connect(signer) as PangolinV2PoolDeployer__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PangolinV2PoolDeployer {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as PangolinV2PoolDeployer;
  }
}

...
interface IPangolinV2PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class IPangolinV2PoolEvents extends Contract {
  ...
  interface: IPangolinV2PoolEventsInterface;

...
interface TestPangolinV2CalleeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestPangolinV2Callee extends Contract {
  ...
  interface: TestPangolinV2CalleeInterface;

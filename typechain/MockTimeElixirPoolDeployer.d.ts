...
interface MockTimeElixirPoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeElixirPoolDeployer extends Contract {
  ...
  interface: MockTimeElixirPoolDeployerInterface;

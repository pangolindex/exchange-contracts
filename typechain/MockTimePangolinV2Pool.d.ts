...
interface MockTimePangolinV2PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimePangolinV2Pool extends Contract {
  ...
  interface: MockTimePangolinV2PoolInterface;

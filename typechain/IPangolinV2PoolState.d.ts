...
interface IPangolinV2PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IPangolinV2PoolState extends Contract {
  ...
  interface: IPangolinV2PoolStateInterface;

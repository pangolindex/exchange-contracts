...
interface IPangolinV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IPangolinV2Factory extends Contract {
  ...
  interface: IPangolinV2FactoryInterface;

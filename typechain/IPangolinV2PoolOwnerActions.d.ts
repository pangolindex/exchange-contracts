...
interface IPangolinV2PoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IPangolinV2PoolOwnerActions extends Contract {
  ...
  interface: IPangolinV2PoolOwnerActionsInterface;

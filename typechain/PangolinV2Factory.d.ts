...
interface PangolinV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class PangolinV2Factory extends Contract {
  ...
  interface: PangolinV2FactoryInterface;

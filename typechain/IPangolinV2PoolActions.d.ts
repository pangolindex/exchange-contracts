...
interface IPangolinV2PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IPangolinV2PoolActions extends Contract {
  ...
  interface: IPangolinV2PoolActionsInterface;

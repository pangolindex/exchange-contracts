...
import '../elixir-core/libraries/FixedPoint128.sol';
import '../elixir-core/libraries/FullMath.sol';
import '../elixir-rewarder/interfaces/IElixirRewarder.sol';
...
/// @title NFT positions
/// @notice Wraps Elixir positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the elixir position
    struct Position {
    ...
    address private _elixirRewarder;

    constructor(
        address _factory,
        address _WETH9,
        address _tokenDescriptor_,
        address _elixirRewarder_
    ) ERC721Permit('Elixir Positions NFT', 'IXIR-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
    ...
    function updateRewardManager(address _elixirRewarder_) external payable override onlyFactoryOwner {
        _elixirRewarder = _elixirRewarder_;
    }
    ...
    function _updateReward(Position storage position, IElixirPool pool) internal {

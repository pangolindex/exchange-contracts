...
import '../elixir-core/libraries/LowGasSafeMath.sol';
...
import './interfaces/IElixirMigrator.sol';
...
contract ElixirMigrator is IElixirMigrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        // calculate the amounts to migrate to elixir

...
import 'openzeppelin-contracts-solc-0.7/token/ERC721/IERC721Metadata.sol';
import 'openzeppelin-contracts-solc-0.7/token/ERC721/IERC721Enumerable.sol';
...
/// @notice Wraps Elixir positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
    ...
    IERC721Permit
{
    ...
    /// @notice Emitted when Elixir Rewarder is called and notified of the reward amount
    /// @dev This only notifies that the Elixir Rewarder is called. Except some edge cases (which will be documented in Elixir
    /// Rewarder), this event is a good indicator of the rewards being claimed. However, it is not certain as it depends on
    /// Elixir Rewarder implementation to decide whether to send the rewards.

...
contract OracleTest {
    ...
    uint144 public rewardPerSecondX48;
    uint32 public rewardRateEffectiveUntil;
    ...
    function batchUpdate(UpdateParams[] calldata params) external {
        ...
        uint32 _time = time;
        uint144 _rewardPerSecondX48 = rewardPerSecondX48;
        uint32 _rewardRateEffectiveUntil = rewardRateEffectiveUntil;

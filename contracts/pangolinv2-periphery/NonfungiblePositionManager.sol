...
/// @title NFT positions
/// @notice Wraps Pangolin V2 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IPangolinV2Pool pool = IPangolinV2Pool(PoolAddress.computeAddress(factory, poolKey));

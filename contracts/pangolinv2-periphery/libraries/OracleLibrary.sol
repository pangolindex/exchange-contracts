...
library OracleLibrary {
    /// @notice Calculates time-weighted means of tick and liquidity for a given Pangolin V2 pool
    ...
    /// @param pool Address of Pangolin V2 pool that we want to observe
    ...
    /// @param pool Address of Pangolin V2 pool
    /// @return The tick that the pool was in at the start of the current block
    function getBlockStartingTickAndLiquidity(address pool) internal view returns (int24, uint128) {
        (, int24 tick, uint16 observationIndex, uint16 observationCardinality, , , ) = IPangolinV2Pool(pool).slot0();

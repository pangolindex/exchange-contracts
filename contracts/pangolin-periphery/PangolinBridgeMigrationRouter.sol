...
contract PangolinBridgeMigrationRouter {
    ...
    function _calculateRescueLiquidity(address pairAddress, address amount) internal view returns (uint amount0, uint amount1) {
        ...
        amount0 = amount.mul(totalSupply).div(reserves0);
        amount1 = amount.mul(totalSupply).div(reserves1);
    }

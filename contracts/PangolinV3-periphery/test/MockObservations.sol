...
import "../../PangolinV3-core/libraries/Oracle.sol";
...
contract MockObservations {
    ...
    constructor(
        ...
        uint192[4] memory _rewardPerLiquidityCumulativeX64,
        int24 _tick,
        ...
        for (uint256 i = 0; i < _blockTimestamps.length; i++) {
            oracleObservations[i] = Oracle.Observation({
                ...
                rewardPerLiquidityCumulativeX64: _rewardPerLiquidityCumulativeX64[
                    i
                ]
            });
        }

...
contract TestPangolinV3Callee is IPangolinV3SwapCallback {
    ...
    function pangolinv3SwapCallback(
        ...
        if (amount0Delta > 0) {
            IERC20(IPangolinV3Pool(msg.sender).token0()).transferFrom(
                sender,
                msg.sender,
            ...
            IERC20(IPangolinV3Pool(msg.sender).token1()).transferFrom(
                sender,
                msg.sender,

...
describe("PangolinV2Pool", () => {
  ...
  let pool0: MockTimePangolinV2Pool;
  let pool1: MockTimePangolinV2Pool;
  ...
  let swapTargetCallee: TestPangolinV2Callee;
  let swapTargetRouter: TestPangolinV2Router;
  ...
  beforeEach("deploy first fixture", async () => {
    ...
    ): Promise<[MockTimePangolinV2Pool, any]> => {

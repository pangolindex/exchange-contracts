...
describe("LiquidityAmounts", async () => {
  ...
  before("deploy test library", async () => {
    const liquidityFromAmountsTestFactory = await ethers.getContractFactory(
      "LiquidityAmountsTest"
    );
    liquidityFromAmounts =
      (await liquidityFromAmountsTestFactory.deploy()) as LiquidityAmountsTest;
  });
  ...
  describe("#getLiquidityForAmount0", () => {
    it("gas", async () => {
      ...
      await snapshotGasCost(
        liquidityFromAmounts.getGasCostOfGetLiquidityForAmount0(
          sqrtPriceAX96,
          sqrtPriceBX96,
          100
        )
  ...
  describe("#getLiquidityForAmount1", () => {
    it("gas", async () => {
      ...
      const sqrtPriceBX96 = encodePriceSqrt(110, 100);
      await snapshotGasCost(
        liquidityFromAmounts.getGasCostOfGetLiquidityForAmount1(
          sqrtPriceAX96,
          sqrtPriceBX96,
          100
        )
  ...
  describe("#getAmount0ForLiquidity", () => {
    it("gas", async () => {
      ...
      const sqrtPriceBX96 = encodePriceSqrt(110, 100);
      await snapshotGasCost(
        liquidityFromAmounts.getGasCostOfGetAmount0ForLiquidity(
          sqrtPriceAX96,
          sqrtPriceBX96,
          100
        )
  ...
  describe("#getLiquidityForAmount1", () => {
    it("gas", async () => {
      ...
      const sqrtPriceBX96 = encodePriceSqrt(110, 100);
      await snapshotGasCost(
        liquidityFromAmounts.getGasCostOfGetAmount1ForLiquidity(
          sqrtPriceAX96,
          sqrtPriceBX96,
          100
        )
  ...
  describe("#getAmountsForLiquidity", () => {
    it("amounts for price inside", async () => {
      ...
      const { amount0, amount1 } =
        await liquidityFromAmounts.getAmountsForLiquidity(
          sqrtPriceX96,
          sqrtPriceAX96,
          sqrtPriceBX96,
          2148

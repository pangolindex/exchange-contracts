...
import { TestElixirSwapPay } from "../../typechain/TestElixirSwapPay";
...
import { TestElixirReentrantCallee } from "../../typechain/TestElixirReentrantCallee";
...
describe("ElixirPool", () => {
  ...
  let pool: MockTimeElixirPool;

  let swapTarget: TestElixirCallee;
  ...
  describe("#lock", () => {
    ...
    it("cannot reenter from swap callback", async () => {
      const reentrant = (await (
        await ethers.getContractFactory("TestElixirReentrantCallee")
      ).deploy()) as TestElixirReentrantCallee;
  ...
  describe("swap underpayment tests", () => {
    let underpay: TestElixirSwapPay;

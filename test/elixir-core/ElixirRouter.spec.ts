...
describe("ElixirPool", () => {
  ...
  let pool0: MockTimeElixirPool;
  let pool1: MockTimeElixirPool;
  ...
  let swapTargetCallee: TestElixirCallee;
  let swapTargetRouter: TestElixirRouter;
  ...
  beforeEach("deploy first fixture", async () => {
    ...
    ): Promise<[MockTimeElixirPool, any]> => {

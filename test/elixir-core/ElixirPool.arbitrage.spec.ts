...
import { ElixirPoolSwapTest } from "../../typechain/ElixirPoolSwapTest";
...
describe("ElixirPool arbitrage tests", () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(
          ...
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const tester = (await testerFactory.deploy()) as ElixirPoolSwapTest;
